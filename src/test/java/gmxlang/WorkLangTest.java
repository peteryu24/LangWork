...
public class WorkLangTest {
	...
	public void runAddLangWork() {
		...
		DataBinder dataBinder = new DataBinder(contentVo);
		BindingResult bindingResult = dataBinder.getBindingResult();
		GmxResult expected = new GmxResult().result(true);
		when(contentService.addLangWork(contentVo)).thenReturn(expected);
		GmxResult result = contentController.addLangWork(contentVo, bindingResult);
	...
	public void runModifyLangWork() {
		...
		GmxResult result = contentController.modifyLangWork(contentVo, bindingResult);
		assertEquals(expected, result);
	}
